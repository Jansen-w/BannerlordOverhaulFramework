...
using System.Linq;
using BOF.Campaign.CampaignSystem;
using Helpers;
...
using CampaignData = BOF.Campaign.CampaignSystem.CampaignData;
using CampaignTime = BOF.Campaign.CampaignSystem.CampaignTime;
