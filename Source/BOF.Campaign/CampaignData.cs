using CampaignTime = BOF.Campaign.CampaignTime;
...
namespace BOF.Campaign
{
  public static class CampaignData
  {
    ...
    public static uint NeutralColor1 => CampaignData.NeutralFaction.Color;

    public static uint NeutralColor2 => CampaignData.NeutralFaction.Color2;
    ...
    public static Clan NeutralFaction
    {
      ...
      private set => CampaignData._neutralFaction = value;
    }

    public static void OnGameEnd() => CampaignData.NeutralFaction = (Clan) null;
  }
}