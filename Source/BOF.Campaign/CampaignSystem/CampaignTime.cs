...
namespace BOF.Campaign.CampaignSystem
{
  public struct CampaignTime : IComparable<CampaignTime>
  {
    ...
    public static object AutoGeneratedGetMemberValue_numTicks(object o) => (object) ((CampaignTime) o)._numTicks;
    ...
    public bool IsDayTime
    {
      get
      {
        int num = MBMath.Floor(this.ToHours) % 24;
        return num >= 2 && num < 22;
      }
    }
    ...
    public static CampaignTime Milliseconds(long valueInMilliseconds) => new CampaignTime(valueInMilliseconds * 10L);

    public static CampaignTime MillisecondsFromNow(long valueInMilliseconds) => new CampaignTime(CampaignTime.CurrentTicks + valueInMilliseconds * 10L);

    public static CampaignTime Seconds(long valueInSeconds) => new CampaignTime(valueInSeconds * 10000L);

    public static CampaignTime SecondsFromNow(long valueInSeconds) => new CampaignTime(CampaignTime.CurrentTicks + valueInSeconds * 10000L);

    public static CampaignTime Minutes(long valueInMinutes) => new CampaignTime(valueInMinutes * 600000L);

    public static CampaignTime MinutesFromNow(long valueInMinutes) => new CampaignTime(CampaignTime.CurrentTicks + valueInMinutes * 600000L);

    public static CampaignTime Hours(float valueInHours) => new CampaignTime((long) ((double) valueInHours * 36000000.0));

    public static CampaignTime HoursFromNow(float valueInHours) => new CampaignTime(CampaignTime.CurrentTicks + (long) ((double) valueInHours * 36000000.0));

    public static CampaignTime Days(float valueInDays) => new CampaignTime((long) ((double) valueInDays * 864000000.0));

    public static CampaignTime DaysFromNow(float valueInDays) => new CampaignTime(CampaignTime.CurrentTicks + (long) ((double) valueInDays * 864000000.0));

    public static CampaignTime Weeks(float valueInWeeeks) => new CampaignTime((long) ((double) valueInWeeeks * 6048000000.0));

    public static CampaignTime WeeksFromNow(float valueInWeeks) => new CampaignTime(CampaignTime.CurrentTicks + (long) ((double) valueInWeeks * 6048000000.0));

    public static CampaignTime Seasons(float valueInSeasons) => new CampaignTime((long) ((double) valueInSeasons * 18144000000.0));

    public static CampaignTime Years(float valueInYears) => new CampaignTime((long) ((double) valueInYears * 72576000000.0));

    public static CampaignTime YearsFromNow(float valueInYears) => new CampaignTime(CampaignTime.CurrentTicks + (long) ((double) valueInYears * 72576000000.0));

    public static CampaignTime Zero => new CampaignTime(0L);

    public static CampaignTime operator +(CampaignTime g1, CampaignTime g2) => new CampaignTime(g1._numTicks + g2._numTicks);

    public static CampaignTime operator -(CampaignTime g1, CampaignTime g2) => new CampaignTime(g1._numTicks - g2._numTicks);

    public bool StringSameAs(CampaignTime otherTime) => this._numTicks / 864000000L == otherTime.NumTicks / 864000000L;
    ...
    public override string ToString()
    {
      ...
      TextObject text = GameTexts.FindText("str_date_format_" + (object) getSeasonOfYear);
