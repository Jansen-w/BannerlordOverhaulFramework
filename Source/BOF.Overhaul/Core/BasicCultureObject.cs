...
namespace BOF.Overhaul.Core
{
  public class BasicCultureObject : MBObjectBase
  {
    ...
    {
      CultureCode result;
      if (Enum.TryParse<CultureCode>(this.StringId, true, out result))
        return result;
      Debug.FailedAssert("Could not get CultureCode from stringId: " + this.StringId, "C:\\Develop\\mb3\\Source\\Bannerlord\\TaleWorlds.Core\\BasicCultureObject.cs", nameof (GetCultureCode), 83);
